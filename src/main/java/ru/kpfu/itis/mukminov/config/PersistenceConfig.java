...
@EnableJpaRepositories("ru.kpfu.itis.mukminov.repository")
public class PersistenceConfig implements EnvironmentAware {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ru.kpfu.itis.mukminov.model");
    ...
    public LocalSessionFactoryBean localSessionFactoryBean() {
        ...
        sessionFactory.setPackagesToScan("ru.kpfu.itis.mukminov.model");
